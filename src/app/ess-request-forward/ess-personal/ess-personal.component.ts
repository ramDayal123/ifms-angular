  ...
  @Component({
    selector: 'app-ess-personal',
    templateUrl: './ess-personal.component.html',
    styleUrls: ['./ess-personal.component.css']
  })
  export class EssPersonalComponent implements OnInit {
    ...
    ngOnInit(): void {
      this.EmpSelfDetailForm = this.formbuilder.group({
        ...
        percentageDisability:['0',Validators.required],
        height:['0',Validators.required],
        identificationMark:['0',Validators.required],
